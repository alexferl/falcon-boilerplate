...
p = argparse.ArgumentParser(description="Runs the App")
...
# Gunicorn
gu = p.add_argument_group("Gunicorn")
...
# Middleware
m = p.add_argument_group("Middleware")
...
l.add_argument("--log-handlers", type=list, default=["console"],
